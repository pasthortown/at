...
export class ProfilePageComponent implements OnInit {
  ...
  constructor(private spinner: NgxSpinnerService, private authDataService: AuthService, private router: Router) { }
  ...
  save_profile() {
    ...
    this.spinner.show();
    this.authDataService.update_user(this.user.item_id, toSave).then( r => {
      this.spinner.hide();
      Swal.fire({
